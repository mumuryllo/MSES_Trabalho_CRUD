...
public class Controller extends HttpServlet {
	...
	private void insertCarros(HttpServletRequest tomate, HttpServletResponse alface) throws ServletException, IOException{
	...
	private void selectAllCarros(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		request.setAttribute("listCarros", this.cont.selectAll());
	...
	private void updateCarros(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String anoBack = request.getParameter("name");
		String modeloBack = request.getParameter("email");
		String idBack = request.getParameter("id");
