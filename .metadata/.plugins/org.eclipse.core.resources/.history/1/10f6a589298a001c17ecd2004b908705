...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand" id="navbar-brand" href="#">Tabela de Ipva</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a class="nav-link active" id="navbar-brand" aria-current="page" href="#">Painel</a>
                </div>
            </div>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="container-form">
            ...
            <div class="form">
                ...
                <h1 class="title">Adicionar Carros</h1>
